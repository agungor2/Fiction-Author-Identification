# -*- coding: utf-8 -*-
"""
Created on Sat Apr 21 15:07:06 2018

@author: mgungor
Doc2vec for 3 author datasets
...
ytrain = sc.loadmat("ytrain.mat")["ytrain"]
test_author = sc.loadmat("yvalid.mat")["yvalid"]
ytrain = ytrain.transpose()
test_author = test_author.transpose()
...
print("f1 Score")
print(f1_score(test_author, predictions, average='macro'))
print("Accuracy")
